...
const ShareModal = ({ isOpen, onClose, title, url = window.location.href }) => {
  ...
  const shareOnSocial = (platform) => {
    ...
    switch (platform) {
      ...
      case 'linkedin':
        ...
        break;
      case 'instagram':
        // Instagram doesn't have a direct sharing API, so we'll just show a toast notification
        toast.info("Instagram sharing is not directly available. Try copying the link instead.");
        return;
    }
            ...
            <div className="relative">
              ...
              <div className="flex">
                <div className="flex-1 rounded-l-md truncate">
                  <p className="appearance-none px-5 py-[10px] rounded-[30px] w-full block outline-none border bg-[#ffffff1b] text-white __text custom_input_component truncate">{url}</p>
                </div>
                <Button
